...
!(function (t) {
	...
	var savedSidebarState = getSidebarState();
	if (savedSidebarState === "toggled") {
	...
	t("#sidebarToggle, #sidebarToggleTop").on("click", function (o) {
		...
		// Save the current sidebar state in localStorage
		if (t(".sidebar").hasClass("toggled")) {
			setSidebarState("toggled");
			t(".sidebar-heading").css('padding', '0');
		} else {
			setSidebarState("");
			t(".sidebar-heading").css('padding', '0 1rem');
		}
